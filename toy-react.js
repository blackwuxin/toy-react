...
export function render(component, partentElement) {
    let range = document.createRange();
    range.setStart(partentElement,0);
    range.setEnd(partentElement,partentElement.childNodes.length);
    range.deleteContents();
    component[RENDER_TO_DOM](range);
}
